...
def draw_two_routes(input_files: list, outputfile: str):
    # 只需兩種顏色，因為只繪製兩條路線
    colors = ['blue', 'green'] 
    ...
    for idx, file in enumerate(input_files):
        ...
        color = colors[idx % len(colors)] # 确保只有两种颜色
...
if __name__ == "__main__":
    ...
    outputfile = "20250429/bus_routes_only_two_lines.png"

    # 直接呼叫繪圖函數，無需其他功能
    draw_two_routes(input_files, outputfile)

    print(f"兩條公車路線圖已儲存至 {outputfile}")